...
function HeadingIntro() {
  return (
    <div>
      ...
      <h2>Below is information about the teams in NCAA college basketball. Here is information about each team!</h2>
    </div>
  )
}
...
function TeamList() {
  return (
    <div>
      {team.map(singleTeam => <TeamInfo {...singleTeam}/>)}
    </div>
  )
}
function App() {
